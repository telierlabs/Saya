...
// Pastikan path ke components menggunakan huruf kecil sesuai folder di GitHub
import { Layout } from './components/Layout'; 
import { Movie, PageView } from './types';
import { HERO_MOVIE, TOP_MOVIES } from './constants';
// Tambahkan ekstensi .ts agar Vite di Vercel tidak bingung mencari file
import { auth, onAuthStateChanged } from './services/firebase.ts'; 
...
const App: React.FC = () => {
    ...
    useEffect(() => {
        // Melakukan pengecekan status login user
    ...
    return (
        <Layout currentPage={currentPage}>
            <div className="space-y-12">
                {/* Hero Section - Menampilkan Film Utama */}
                ...
                {/* Movie Grid - Daftar Film Trending */}
                <section>
